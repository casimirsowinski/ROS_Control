...
class HeadTracker():
	...
	##self.camera_link = rospy.get_param('~camera_link', 'camera_link')
 	self.camera_link = rospy.get_param('~head_tracker_B_link', 'head_tracker_B_link')	
	#self.camera_link = rospy.get_param('~realsense_link', 'realsense_link')
        ...
        self.max_pan = rospy.get_param('~max_pan', radians(180))
        self.min_pan = rospy.get_param('~min_pan', radians(-180))
        self.max_tilt = rospy.get_param('~max_tilt', radians(180))
        self.min_tilt = rospy.get_param('~min_tilt', radians(-180))        
